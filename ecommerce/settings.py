...
ALLOWED_HOSTS = ['localhost', 'jj-e-commerce.herokuapp.com']
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'django.template.context_processors.media',      # media context processor to handle images
                'cart.contexts.cart_contents',                   # added for
            ],
        },
    },
]
...
AWS_STORAGE_BUCKET_NAME = 'jj-commerce-bucket'
